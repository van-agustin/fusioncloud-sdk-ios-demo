...
public enum FoundationSecurityErrorA: Error {
    case invalidRequest
}

public class FoundationSecurityA  {
...
extension FoundationSecurityA: CertificatePinning {
...
//extension FoundationSecurityA: HeaderValidator {
